...
#force scope
{
	...
	if($BARCODE eq ""){
		# push the ionstats_alignment.json file if this is not a barcoded runs. The ionstats_alignment statistics are not available for barcoded runs. They will be generated by the scripts.
